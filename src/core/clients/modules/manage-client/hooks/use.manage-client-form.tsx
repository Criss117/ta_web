...
import useMangeClient from "./use.manage-client";

const useManageClientForm = ({ clientId }: { clientId: number }) => {
  const { onCreateDebtPay: onMutate, createDebtPay } = useMangeClient();
...
export default useManageClientForm;
